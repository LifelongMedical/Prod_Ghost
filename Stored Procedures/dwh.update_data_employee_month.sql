...
AS
	...
	-- interfering with SELECT statements.
        ...
        SELECT IDENTITY( INT, 1, 1 )  AS employee_month_key ,  
		ar.*,
		...
		--Employee current
                     WHEN COALESCE(ar.[Hire Date], 0) != 0
                          ...
                          AND first_mon_date >= CAST(CONVERT(VARCHAR(6), ar.[Hire Date], 112) + '01' AS DATE) THEN  DATEDIFF(YEAR,CAST(CONVERT(VARCHAR(6),ar.[Date of Birth], 112) + '01' AS DATE),CAST(CONVERT(VARCHAR(6),tim.first_mon_date, 112) + '01' AS DATE))
