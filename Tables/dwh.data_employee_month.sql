CREATE TABLE [dwh].[data_employee_month]
(
...
[nbr_census_employee] [int] NOT NULL,
[nbr_census_separated] [int] NOT NULL,
[nbr_census_bad_hire] [int] NOT NULL,
[months_since_start] [int] NULL,
[fte_created] [numeric] (4, 3) NULL
) ON [PRIMARY]
GO
ALTER TABLE [dwh].[data_employee_month] ADD CONSTRAINT [employee_month_key_pk] PRIMARY KEY CLUSTERED  ([employee_month_key]) ON [PRIMARY]
GO
