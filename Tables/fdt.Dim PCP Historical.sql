CREATE TABLE [fdt].[Dim PCP Historical]
(
[user_key] [int] NOT NULL IDENTITY(1, 1),
[employee_key] [int] NULL,
[PCP Historical] [varchar] (52) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
ALTER TABLE [fdt].[Dim PCP Historical] ADD CONSTRAINT [user_key_pk18] PRIMARY KEY CLUSTERED  ([user_key]) ON [PRIMARY]
GO
