CREATE TABLE [fdt].[Fact CHCN Patient]
(
...
ALTER TABLE [fdt].[Fact CHCN Patient] ADD 
CONSTRAINT [PK__Fact CHC__2852397ADB2987A0] PRIMARY KEY CLUSTERED  ([chcn_key]) ON [PRIMARY]
