CREATE TABLE [fdt].[Fact Encounter and Appointment_OLD]
(
...
[Payer 1 Name] [varchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Payer 1 Financial Class] [varchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Payer 2 Name] [varchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Payer 2 Financial Class] [varchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Payer 3 Name] [varchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Payer 3 Financial Class] [varchar] (40) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
[Date of Last Appointment] [date] NULL,
[Date of Last Encounter] [date] NULL
) ON [PRIMARY]
GO
ALTER TABLE [fdt].[Fact Encounter and Appointment_OLD] ADD CONSTRAINT [enc_appt_keypk] PRIMARY KEY CLUSTERED  ([enc_appt_key]) ON [PRIMARY]
GO
